...
const Heaven = () => {
    return (
        <div className="">
            ...
            <div className="">
                <img className="bg-fixed w-full h-64 md:h-96 lg:h-[680px] object-cover" src="https://images.coolwallpapers.me/picsup/2841140-landscape-nature-village-mountain-house-road-grass-shrubs-trees-valley___landscape-nature-wallpapers.jpg" alt="Landscape" />
            </div>
